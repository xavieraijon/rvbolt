...
/* dbcheck.twig */
class __TwigTemplate_8b4922af39c06a13b683b9d069998079e404d7c5d24b92454d06bedea56307ae extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 7
                echo "            <li>";
                echo $this->env->getExtension('Bolt')->decorateTT((isset($context["item"]) ? $context["item"] : null));
                echo "</li>
        ";
            }
    ...
    ";
        } elseif ((isset($context["required_modifications"]) ? $context["required_modifications"] : null)) {
            // line 19
            echo "        <h4>";
        ...
        ";
            // line 21
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["required_modifications"]) ? $context["required_modifications"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 22
                echo "            <li>";
                echo $this->env->getExtension('Bolt')->decorateTT((isset($context["item"]) ? $context["item"] : null));
